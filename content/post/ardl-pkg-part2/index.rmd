...
It starts with the version 0.1.1 which adds some extra features in the `multipliers` function. This new release also includes some minor corrections in the documentation.
...
This is useful as you can get the instant impact (Short-Run) of a variable's change, or the impact in 1, 2 or whatever number of periods ahead you want. And it is as easy as specifying the type (for long or short run) or the number of periods for the interim multipliers. For example:
